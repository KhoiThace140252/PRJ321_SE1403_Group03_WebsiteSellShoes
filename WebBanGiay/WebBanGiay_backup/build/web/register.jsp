                    ...
                    <div class="reg">
                        ...
                        <form action="LoginController?action=Res" method="post" name="register">
                            ...
                            <ul>
                                ...
                                <li><input type="text" name="taiKhoan" value="" id="username"></li>
                            </ul>				 
                            <ul>
                                <li class="text-info">Password: </li>
                                <li><input type="password" name="matKhau" value="" id="password"></li>
                            </ul>      
                            <ul>
                                <li class="text-info">Gender: </li>
                                <li>
                                    <select name="gioiTinh" >
                                        <option style="color: #black" class="Sex" value="Nam">Male</option>
                                        <option style="color: #black"  class="Sex" value="Nữ">Female</option>
                                        <option style="color: #black" class="Sex" value="Khác">Other</option>
                                    </select>
                                </li>
                            ...
                            <ul>
                                ...
                                <li><input type="text" name="email" value="" id="email"></li>
                            </ul>
                            <ul>
                            ...
                            <ul>
                                ...
                                <li><input type="text" name="soDienThoai" value="" id="phone"></li>
                            </ul>	
                            <ul>
                                <li class="text-info">Address:</li>
                                <li><input type="text" name="diaChi" value="" id="address"></li>
                            </ul>	          
